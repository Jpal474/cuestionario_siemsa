...
def guardar_propiedad(request):
    ...
    propiedad.respuesta6=request.POST.get('estrategia')
    propiedad.evidencia6=request.POST.get('evidencia_estrategia')
    ...
    respuestas=[propiedad.respuesta2_2, propiedad.respuesta3_3, propiedad.respuesta3_4, propiedad.respuesta2_6, propiedad.respuesta3_6, propiedad.respuesta6, propiedad.respuesta7, propiedad.respuesta4_7, propiedad.respuesta5_4, propiedad.respuesta4_8]
    evidencias=[propiedad.evidencia2_2, propiedad.evidencia3_3, propiedad.evidencia3_4, propiedad.evidencia2_6, propiedad.evidencia3_6, propiedad.evidencia6, propiedad.evidencia7, propiedad.evidencia4_7, propiedad.evidencia5_4, propiedad.evidencia4_8]
    resultados=[0]*len(respuestas)
    cont=0
    promedio_area=0
    ...
    evaluacion.pregunta6=resultados[5]
...
=======
    ...
    if evaluacion.pregunta1_1==100:
        reco[0]="Cuenta con un GRUPO DE INVESTIGACIÓN Y DESARROLLO adecuado y acorde a las características técnicas, administrativas y operativas que demanda el proyecto, además ha documentado satisfactoriamente toda la información necesaria y anexos que validan el perfil y experiencia de cada miembro del GRUPO DE INVESTIGACIÓN Y DESARROLLO."
    elif evaluacion.pregunta1_1==0:
        reco[0]="No ha iniciado con la INVESTIGACIÓN BÁSICA DE SU IDEA, es necesario identificar una problemática a resolver, investigar principios de investigación básica que pudieran transformarse en principios básicos para aplicarse a nuevas tecnologías."
    ...
    if evaluacion.pregunta1_2==100:
        reco[1]="La IDENTIFICACIÓN DE PRINCIPIOS DE INVESTIGACIÓN BÁSICA de su idea se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta1_2==0:
        reco[1]="No ha iniciado con la IDENTIFICACIÓN DE PRINCIPIOS DE INVESTIGACIÓN BÁSICA, es necesario identificar estos principios que pudieran transformarse en principios básicos para aplicarse a nuevas tecnologías."
    ...
    if evaluacion.pregunta2_1==100:
        reco[2]="El ESTUDIO DEL ESTADO DE LA TÉCNICA que respalda la aplicación de la idea en algún área tecnológica se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta2_1==0:
        reco[2]="No ha iniciado con el ESTUDIO DEL ESTADO DE LA TÉCNICA que respalda la aplicación de la idea en algún área tecnológica, es necesario realizar estudios del estado de la técnica, proponer alternativas de solución y documentar el proceso"
    elif evaluacion.pregunta1_1<=13:
    ...
    if evaluacion.pregunta4_2==100:
        reco[3]="Las PRUEBAS A NIVEL LABORATORIO para validar la efectividad de su invención a nivel laboratorio y en condiciones controladas se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_2==0:
       reco[3]="No ha iniciado con las PRUEBAS A NIVEL LABORATORIO para validar la efectividad de su invención a nivel laboratorio y en condiciones controladas, es necesario iniciar con pruebas de baja confiabilidad para validar la efectividad de su invención."
    ...
    if evaluacion.pregunta4_5==100:
        reco[4]="Las PRUEBAS A NIVEL LABORATORIO para validar la funcionalidad de su invención a nivel laboratorio y en condiciones controladas se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_5==0:
        reco[4]="No ha realizado PRUEBAS A NIVEL LABORATORIO para validar la funcionalidad de su invención a nivel laboratorio y en condiciones controladas, es necesario realizar pruebas de baja confiabilidad para validar la funcionalidad de su invención."
    ...
    if evaluacion.pregunta5_1==100:
        reco[5]="Las PRUEBAS EN ENTORNO RELEVANTE para validar la efectividad de su invención a nivel laboratorio pero en condiciones que simulan un entorno real se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta5_1==0:
        reco[5]="No ha iniciado con las PRUEBAS EN ENTORNO RELEVANTE para validar la efectividad de su invensión a nivel laboratorio pero en condiciones que simulan un entorno real, es necesario iniciar con pruebas de baja confiabilidad para validar la efectividad de su invensión."
...
=======
    if evaluacion.pregunta8_2==100:
        reco[8]="Las PRUEBAS DE PRODUCTO COMERCIALIZABLE en su configuración final para demostración, evaluación y certificación del sistema completo en un ambiente operativo real, así como manufacturabilidad probada se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta8_2==0:
        reco[8]="No ha iniciado con las PRUEBAS DE PRODUCTO COMERCIALIZABLE en su configuración final, es necesaria la realizacón de pruebas para la demostración, evaluación y certificación del sistema completo en un ambiente operativo real, así como probar su manufacturabilidad."
    ...
    if evaluacion.pregunta9_1==100:
        reco[9]="Se realiza la PRODUCCIÓN SOSTENIDA del producto terminado, se han realizado pruebas exitosas en entornos reales y la tecnología se encuentra disponible en el mercado, los procesos de producción y pruebas se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta9_1==0:
        reco[9]="No se realiza la PRODUCCIÓN SOSTENIDA del producto terminado, tampoco se han realizado pruebas exitosas en entornos reales y la tecnología no se encuentra disponible en el mercado."
    ...
    if evaluacion.pregunta9_3==100:
        reco[10]="Se realizan CAMBIOS INCREMENTALES del producto terminado, en la búsqueda de la mejora continua que lleven a crear nuevas versiones del producto, el proceso de mejora continua se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta9_3==0:
        reco[10]="No se realizan CAMBIOS INCREMENTALES del producto terminado que lleven a la mejora continua y permitan crear nuevas versiones del producto."
    elif evaluacion.pregunta9_3<=13:
        reco[10]="No se está seguro de realizar CAMBIOS INCREMENTALES del producto terminado, sin embargo, es muy probable que no se realicen acciones de mejora continua que lleven a crear nuevas versiones del producto. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta9_3<=25:
        reco[10]="Ya ha iniciado a realizar CAMBIOS INCREMENTALES del producto terminado, en la búsqueda de la mejora continua que lleven a crear nuevas versiones del producto, sin embargo, es necesario documentar el proceso. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta9_3<=50:
        reco[10]="Ya ha iniciado a realizar CAMBIOS INCREMENTALES del producto terminado que lleven a la mejora continua y permitan crear nuevas versiones del producto, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."



    if evaluacion.pregunta2_5==100:
        reco[11]="Cuenta con un GRUPO DE INVESTIGACIÓN Y DESARROLLO adecuado y acorde a las características técnicas, administrativas y operativas que demanda el proyecto, además ha documentado satisfactoriamente toda la información necesaria y anexos que validan el perfil y experiencia de cada miembro del GRUPO DE INVESTIGACIÓN Y DESARROLLO."
    elif evaluacion.pregunta2_5==0:
        reco[11]="No cuenta con un GRUPO DE INVESTIGACIÓN Y DESARROLLO adecuado y acorde a las características técnicas, administrativas y operativas que demanda el proyecto."   
    ...
    if evaluacion.pregunta2_2==100:
        reco[14]="El BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, incluidos, análisis de patentabilidad y estudios de no infracción indicaron que no existe un desarrollo igual o similar a su invensión; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta2_2==0:
        reco[14]="No ha iniciado con el BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, es necesario realizar un análisis de patentabilidad y estudios de no infracción que arrojen como resultado que no existe un desarrollo igual o similar a su invensión."
    ...
    if evaluacion.pregunta3_3==100:
        reco[15]="La 1ER ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, incluidos, análisis de patentabilidad y estudios de no infracción indicaron que no existe un desarrollo igual o similar a su invensión; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta3_3==0:
        reco[15]="No ha iniciado con la 1ER ACTUALIZACIÓN BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, es necesario realizar un análisis de patentabilidad y estudios de no infracción que arrojen como resultado que no existe un desarrollo igual o similar a su invensión."
    ...
    if evaluacion.pregunta4_7==100:
        reco[16]="La 2DA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, incluidos, análisis de patentabilidad y estudios de no infracción indicaron que no existe un desarrollo igual o similar a su invensión; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_7==0:
        reco[16]="No ha iniciado con la 2DA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, es necesario realizar un análisis de patentabilidad y estudios de no infracción que arrojen como resultado que no existe un desarrollo igual o similar a su invensión."
    ...
    if evaluacion.pregunta5_4==100:
        reco[17]="La 3ER Y ÚLTIMA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, incluidos, análisis de patentabilidad y estudios de no infracción indicaron que no existe un desarrollo igual o similar a su invensión; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta5_4==0:
        reco[17]="No ha iniciado con la 3ER Y ÚLTIMA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, es necesario realizar un análisis de patentabilidad y estudios de no infracción que arrojen como resultado que no existe un desarrollo igual o similar a su invensión."
    elif evaluacion.pregunta5_4<=13:
        reco[17]="No está seguro de haber iniciado la 3ER Y ÚLTIMA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, sin embargo, es muy probable que no cuente con análisis de patentabilidad y estudios de no infracción que arrojen como resultado que no existe un desarrollo igual o similar a su invensión. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta5_4<=25:
        reco[17]="Ya ha iniciado con la 3ER Y ÚLTIMA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, sin embargo, es necesario documentar el proceso realizado; debe contar con análisis de patentabilidad y estudios de no infracción que arrojen como resultado que no existe un desarrollo igual o similar a su invensión. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta5_4<=50:
        reco[17]="Ya ha iniciado con la 3ER Y ÚLTIMA ACTUALIZACIÓN DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, ha realizado análisis de patentabilidad o estudios de no infracción indicaron que no existe un desarrollo igual o similar a su invensión, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
        

    if evaluacion.pregunta3_4==100:
        reco[18]="Los RESULTADOS DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, incluidos, análisis de patentabilidad y estudios de no infracción indicaron que el desarrollo puede ser protegido por algún mecanismo de PROPIEDAD INTELECTUAL; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta3_4==0:
        reco[18]="No cuenta con los RESULTADOS DEL BENCHMARKING TECNOLÓGICO nacional e internacional de su invensión, los cuales arrojan como resultado cual es el mejor mecanismo de PROPIEDAD INTELECTUAL por el cual se puede proteger el desarrollo."
    ...
    if evaluacion.pregunta2_6==100:
        reco[19]="Se ha contemplado un PLAN DE LICENCIAMIENTO de tecnología a terceros, mediante un plan estrategico de transferencia tecnológica; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta2_6==0:
        reco[19]="No se ha contemplado un PLAN DE LICENCIAMIENTO de tecnología a terceros, es necesario realizar un plan estrategico de transferencia tecnológica."
    elif evaluacion.pregunta2_6<=13:
        reco[19]="No está seguro de haber contemplado un PLAN DE LICENCIAMIENTO de tecnología a terceros, sin embargo, es muy probable que no cuente con un plan estrategico de transferencia tecnológica. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta2_6<=25:
        reco[19]="Ya ha contemplado un PLAN DE LICENCIAMIENTO de tecnología a terceros, sin embargo, es necesario documentar el proceso realizado; debe contar con un plan estrategico de transferencia tecnológica. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta2_6<=50:
        reco[19]="Ya ha contemplado un PLAN DE LICENCIAMIENTO de tecnología a terceros, ha realizado un plan estrategico de transferencia tecnológica, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
        

    if evaluacion.pregunta3_6==100:
        reco[20]="Se ha ACTUALIZADO EL PLAN DE LICENCIAMIENTO de tecnología a terceros, mediante un plan estrategico de transferencia tecnológica; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta3_6==0:
        reco[20]="No ha ACTUALIZADO EL PLAN DE LICENCIAMIENTO de tecnología a terceros, es necesario realizar un plan estrategico de transferencia tecnológica."
    elif evaluacion.pregunta3_6<=13:
        reco[20]="No está seguro de haber ACTUALIZADO EL PLAN DE LICENCIAMIENTO de tecnología a terceros, sin embargo, es muy probable que no cuente con un plan estrategico de transferencia tecnológica. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta3_6<=25:
        reco[20]="Ya ha ACTUALIZADO EL PLAN DE LICENCIAMIENTO de tecnología a terceros, sin embargo, es necesario documentar el proceso realizado; debe contar con un plan estrategico de transferencia tecnológica. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta3_36<=50:
        reco[20]="Ya ha ACTUALIZADO EL PLAN DE LICENCIAMIENTO de tecnología a terceros, ha realizado un plan estrategico de transferencia tecnológica, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
        

    if evaluacion.pregunta4_8==100:
        reco[21]="Se ha realizado una 2DA ACTUALIZACIÓN DEL PLAN DE LICENCIAMIENTO de tecnología a terceros, mediante un plan estrategico de transferencia tecnológica; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_8==0:
        reco[21]="No se ha realizado una 2DA ACTUALIZACIÓN DEL PLAN DE LICENCIAMIENTO de tecnología a terceros, es necesario realizar un plan estrategico de transferencia tecnológica."
    elif evaluacion.pregunta4_8<=13:
        reco[21]="No está seguro de haber realizado una 2DA ACTUALIZACIÓN DEL PLAN DE LICENCIAMIENTO de tecnología a terceros, sin embargo, es muy probable que no cuente con un plan estrategico de transferencia tecnológica. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta4_8<=25:
        reco[21]="Ya ha realizado una 2DA ACTUALIZACIÓN DEL PLAN DE LICENCIAMIENTO de tecnología a terceros, sin embargo, es necesario documentar el proceso realizado; debe contar con un plan estrategico de transferencia tecnológica. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta4_8<=50:
        reco[21]="Ya se ha realizado una 2DA ACTUALIZACIÓN DEL PLAN DE LICENCIAMIENTO de tecnología a terceros, ha realizado un plan estrategico de transferencia tecnológica, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
        

    if evaluacion.pregunta6==100:
        reco[22]="La ESTRATEGIA DE PROTECCIÓN INTELECTUAL ha sido identificada y definida, la cual contempla tiempos, redacción de solicitud, componentes a proteger, mecanismo de protección, etcétera; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta6==0:
        reco[22]="No cuenta con una ESTRATEGIA DE PROTECCIÓN INTELECTUAL identificada y definida, la cual contemple tiempos, redacción de solicitud, componentes a proteger, mecanismo de protección, etcétera."
    elif evaluacion.pregunta6<=13:
    ...
    if evaluacion.pregunta7==100:
        reco[23]="La EJECUCIÓN DE LA ESTRATEGIA DE PROTECCIÓN INTELECTUAL, la cual contempla solicitudes, folios, etcétera, se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta7==0:
        reco[23]="No ha realizado la EJECUCIÓN DE LA ESTRATEGIA DE PROTECCIÓN INTELECTUAL, la cual contempla solicitudes, folios, etcétera."
    elif evaluacion.pregunta7<=13:
        reco[23]="No está seguro de haber realizado la EJECUCIÓN DE LA ESTRATEGIA DE PROTECCIÓN INTELECTUAL, sin embargo, es muy probable que no cuente con solicitudes, folios, etcétera. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta7<=25:
        reco[23]="Ya ha realizado la EJECUCIÓN DE LA ESTRATEGIA DE PROTECCIÓN INTELECTUAL, sin embargo, es necesario documentar el proceso realizado; debe contemplar solicitudes, folios, etcétera. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta7<=50:
        reco[23]="Ya ha realizado la EJECUCIÓN DE LA ESTRATEGIA DE PROTECCIÓN INTELECTUAL, ha contemplado solicitudes, folios, etcétera, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta3_5==100:
        reco[24]="El estudio sobre ASPECTOS REGULATORIOS que son requeridos para su invensión tecnológica, incluidos, análisis de comités de ética, normas, ISOs y certificaciones; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta3_5==0:
        reco[24]="No ha iniciado con el estudio sobre ASPECTOS REGULATORIOS que son requeridos para su invensión tecnológica, es necesario realizar un análisis de comités de ética, normas, ISOs y certificaciones."
    ...
    if evaluacion.pregunta5_3==100:
        reco[25]="Los resultados experimentales del prototipo a escala se alinean a los ASPECTOS REGULATORIOS que son requeridos para su invensión tecnológica, incluidos, comités de ética, normas, ISOs, certificaciones, previsiones legales o del medio ambiente del sector; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta5_3==0:
        reco[25]="Los resultados experimentales del prototipo a escala NO se alinean a los ASPECTOS REGULATORIOS que son requeridos para su invensión tecnológica, es necesario realizar un análisis de comités de ética, normas, ISOs, certificaciones, previsiones legales o del medio ambiente del sector."
        ...
        reco[25]="Los resultados experimentales del prototipo a escala se alinean a algunos ASPECTOS REGULATORIOS que son requeridos para su invensión tecnológica, sin embargo, es necesario documentar el proceso realizado; debe contar con análisis de comités de ética, normas, ISOs, certificaciones, previsiones legales o del medio ambiente del sector. Asegure realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta5_3<=50:
        reco[25]="Los resultados experimentales del prototipo a escala se alinean a algunos ASPECTOS REGULATORIOS que son requeridos para su invensión tecnológica, incluyendo comités de ética, normas, ISOs, certificaciones, previsiones legales o del medio ambiente del sector, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
    
    
    
    if evaluacion.pregunta6_5==100:
        reco[26]="Inició el proceso de registro sobre CERTIFICACIONES GUBERNAMENTALES para la producción y despliegue del prototipo, cuenta con documentación oficial que da constancia del inicio de trámites; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta6_5==0:
        reco[26]="No ha iniciado con el proceso de registro sobre CERTIFICACIONES GUBERNAMENTALES para la producción y despliegue del prototipo, es necesario contar con documentación oficial que de constancia del inicio de trámites."
    ...
    if evaluacion.pregunta8_4==100:
        reco[27]="El prototipo CUMPLE con los ESTÁNDARES Y CERTIFICACIONES GUBERNAMENTALES que son requeridos por la industria en cuestión, cuenta con documentación oficial que da constancia del cumplimiento; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta8_4==0:
        reco[27]="El prototipo NO CUMPLE con los ESTÁNDARES Y CERTIFICACIONES GUBERNAMENTALES que son requeridos por la industria en cuestión, es necesario contar con documentación oficial que de constancia del cumplimiento."
        ...
        reco[27]="El prototipo a escala CUMPLE con algunos ESTÁNDARES Y CERTIFICACIONES GUBERNAMENTALES que son requeridos por la industria en cuestión, sin embargo, es necesario contar con documentación oficial que de constancia del cumplimiento. Asegure realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta8_4<=50:
        reco[27]="El prototipo a escala CUMPLE con algunos ESTÁNDARES Y CERTIFICACIONES GUBERNAMENTALES que son requeridos por la industria en cuestión, aparentemente cuenta con documentación oficial que da constancia del cumplimiento o quizá los resultados del trámite no han sido favorables, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
    ...
    if evaluacion.pregunta2_3==100:
        reco[28]="Ha explorado principios básicos de MANUFACTURABILIDAD que son requeridos para su invensión tecnológica, incluidos, identificación, estudios en papel y análisis de enfoques de materiales y procesos; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta2_3==0:
        reco[28]="No ha explorado principios básicos de MANUFACTURABILIDAD que son requeridos para su invensión tecnológica, es necesario realizar la identificación, estudios en papel y análisis de enfoques de materiales y procesos."
        ...
        reco[28]="Ya ha explorado principios básicos de MANUFACTURABILIDAD que son requeridos para su invensión tecnológica, sin embargo, es necesario documentar el proceso realizado; debe contar con una identificación, estudios en papel o análisis de enfoques de materiales y procesos. Asegure realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta2_3<=50:
        reco[28]="Ya ha explorado principios básicos de MANUFACTURABILIDAD que son requeridos para su invensión tecnológica, ha realizado la identificación, estudios en papel y análisis de enfoques de materiales y procesos, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta4_3==100:
        reco[29]="Ha explorado con mayor profundidad los principios de MANUFACTURABILIDAD que son requeridos para su invensión tecnológica, se cuenta con capacidad para producir la tecnología en un entorno de laboratorio, incluidos, la identificación de riesgos de fabricación para la construcción de prototipos y elaboración de planes de mitigación; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_3==0:
        reco[29]="No ha explorado a profundidad los principios de MANUFACTURABILIDAD que son requeridos para su invensión tecnológica, no cuenta con capacidad para producir la tecnología en un entorno de laboratorio; es necesario realizar la identificación de riesgos de fabricación para la construcción de prototipos y elaboración de planes de mitigación."
    ...
    if evaluacion.pregunta5_2==100:
        ...
        reco[30]="Ya ha identificado y considerado plenamente aspectos de MANUFACTURABILIDAD del futuro producto, cuenta con capacidad limitada para producir prototipos en un entorno relevante, sin embargo, es necesario documentar el proceso realizado; debe contar con una evaluación de la base industrial para identificar posibles fuentes de fabricación. Así como haber perfeccionado e integrado una estrategia de fabricación con el plan de gestión de riesgosn. Asegure realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta5_2<=50:
        reco[30]="Ya ha identificado y considerado plenamente aspectos de MANUFACTURABILIDAD del futuro producto, cuenta con capacidad limitada para producir prototipos en un entorno relevante, ha realizado la evaluación de la base industrial para identificar posibles fuentes de fabricación. Ha perfeccionado e integrado una estrategia de fabricación con el plan de gestión de riesgos, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."



    if evaluacion.pregunta6_1==100:
        reco[31]="Ha integrado LAS TECNOLOGÍAS DE PRODUCTO Y DE MANUFACTURA en una planta piloto, considerando, un proceso de definición y caracterización de la mayoría de los procesos de fabricación; este proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta6_1==0:
        reco[31]="No ha integrado LAS TECNOLOGÍAS DE PRODUCTO Y DE MANUFACTURA en una planta piloto; es necesario definir y caracterizar la mayoría de los procesos de fabricación."  
        ...
        reco[31]="Ya ha integrado LAS TECNOLOGÍAS DE PRODUCTO Y DE MANUFACTURA en una planta piloto, sin embargo, es necesario documentar con un proceso de definición y caracterización de la mayoría de los procesos de fabricación. Asegure realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta6_1<=50:
        reco[31]="Ya ha integrado LAS TECNOLOGÍAS DE PRODUCTO Y DE MANUFACTURA en una planta piloto, ha realizado procesos de definición y caracterización de la mayoría de los procesos de fabricación, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta6_2==100:
        reco[32]="Tiene alineado el nuevo producto con las TECNOLOGÍAS DE PRODUCCIÓN, considerando, procesos de aceptación de un diseño de producto preliminar y enfoque de fabricación inicial, así como evaluaciones de manufacturabilidad y estudios comerciales de tecnologías y componentes clave; dicho proceso se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta6_2==0:
        reco[32]="No tiene alineado el nuevo producto con las TECNOLOGÍAS DE PRODUCCIÓN; es necesario realizar procesos de aceptación de un diseño de producto preliminar y enfoque de fabricación inicial, así como evaluaciones de manufacturabilidad y estudios comerciales de tecnologías y componentes clave."
        ...
        reco[32]="Ya tiene alineado el nuevo producto con las TECNOLOGÍAS DE PRODUCCIÓN, sin embargo, es necesario documentar el proceso realizado; debe contar con procesos de aceptación de un diseño de producto preliminar y enfoque de fabricación inicial, así como evaluaciones de manufacturabilidad y estudios comerciales de tecnologías y componentes clave. Asegure realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta6_2<=50:
        reco[32]="Ya tiene alineado el nuevo producto con las TECNOLOGÍAS DE PRODUCCIÓN, ha realizado procesos de aceptación de un diseño de producto preliminar, enfoque de fabricación inicial y/o evaluaciones de manufacturabilidad y estudios comerciales de tecnologías y componentes clave, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta7_1==100:
        reco[33]="Cuenta con un proceso operacional de MANUFACTURA EN BAJA ESCALA con capacidad para producir productos comerciales en un entorno representativo de producción; incluidas, actividades de diseño detallado del producto semi-terminado. También ha probado las especificaciones y disponibilidad de los materiales para cumplir con el cronograma de MANUFACTURA EN BAJA ESCALA; dichos procesos se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta7_1==0:
        reco[33]="No cuenta con un proceso operacional de MANUFACTURA EN BAJA ESCALA, no cuenta con capacidad para producir productos comerciales en un entorno representativo de producción; es necesario realizar actividades de diseño detallado del producto semi-terminado. Así como probar las especificaciones y disponibilidad de los materiales para cumplir con el cronograma de MANUFACTURA EN BAJA ESCALA."   
    ...
    if evaluacion.pregunta2_4==100:
        reco[36]="Ha explorado POSIBLES USUARIOS/MERCADO de su invensión, mediante estudios básicos de mercado e identificación de la problemática a resolver, que le indiquen target potencial, tamaño, localización y características generales; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta2_4==0:
        reco[36]="No ha explorado POSIBLES USUARIOS/MERCADO de su invensión, es necesario realizar estudios básicos de mercado e identificación de la problemática a resolver, que le indiquen target potencial, tamaño, localización y características generales."
        ...
        reco[36]="Ya ha explorado POSIBLES USUARIOS/MERCADO de su invensión, sin embargo, es necesario documentar el proceso realizado; debe contar con estudios básicos de mercado e identificación de la problemática a resolver, que le indiquen target potencial, tamaño, localización y características generales. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta2_4<=50:
        reco[36]="Ya ha explorado POSIBLES USUARIOS/MERCADO de su invensión, ha realizado estudios básicos de mercado e identificación de la problemática a resolver, que le indiquen target potencial, tamaño, localización y características generales, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta3_2==100:
        reco[37]="Ha realizado algún proceso de VALIDACIÓN DE MERCADO de su invensión, mediante una actualización de los estudios de mercado y primeras pláticas y/o reuniones con posibles usuarios, cuenta con actas de reunión y/o cartas de interés de su invensión tecnológica; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta3_2==0:
        reco[37]="No ha realizado ningún proceso de VALIDACIÓN DE MERCADO de su invensión, es necesario realizar una actualización de los estudios de mercado y primeras pláticas y/o reuniones con posibles usuarios, no cuenta con actas de reunión ni cartas de interés de su invensión tecnológica."
        ...
        reco[37]="Ya ha realizado algún proceso de VALIDACIÓN DE MERCADO de su invensión, sin embargo, es necesario documentar el proceso realizado; debe contar una actualización de los estudios de mercado y primeras pláticas y/o reuniones con posibles usuarios, además de actas de reunión y/o cartas de interés de su invensión tecnológica. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta3_2<=50:
        reco[37]="Ya ha realizado algún proceso de VALIDACIÓN DE MERCADO de su invensión, ha realizado una actualización de los estudios de mercado y primeras pláticas y/o reuniones con posibles usuarios, cuenta con actas de reunión y/o cartas de interés de su invensión tecnológica, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta4_4==100:
        reco[38]="HA ACTUALIZADO LA VALIDACIÓN DE MERCADO de su invensión tecnológica, mediante una 2da actualización de los estudios de mercado y más pláticas, reuniones y/o entrevistas con usuarios potenciales, cuenta con actas de reunión y/o cartas de interés de su invensión tecnológica; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_4==0:
        reco[38]="No ha ACTUALIZADO LA VALIDACIÓN DE MERCADO de su invensión tecnológica, es necesario realizar una 2da actualización de los estudios de mercado y más pláticas, reuniones y/o entrevistas con usuarios potenciales, no cuenta con actas de reunión y/o cartas de interés de su invensión tecnológica."
        ...
        reco[38]="Ya ha ACTUALIZADO LA VALIDACIÓN DE MERCADO de su invensión tecnológica, sin embargo, es necesario documentar el proceso realizado; debe contar una 2da actualización de los estudios de mercado y más pláticas, reuniones y/o entrevistas con usuarios potenciales, además de actas de reunión y/o cartas de interés de su invensión tecnológica. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta4_4<=50:
        reco[38]="Ya ha ACTUALIZADO LA VALIDACIÓN DE MERCADO de su invensión tecnológica, ha realizado una 2da actualización de los estudios de mercado y más pláticas, reuniones y/o entrevistas con usuarios potenciales, cuenta con actas de reunión y/o cartas de interés de su invensión tecnológica, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."


    if evaluacion.pregunta6_3==100:
        reco[39]="Cuenta con usuarios potenciales que PRUEBEN LA PRODUCCIÓN A BAJA ESCALA de su producto, ha realizado más pláticas, reuniones y/o entrevistas con los usuarios potenciales, también cuenta con actas de reunión y/o cartas de interés en las pruebas de su producto; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta6_3==0:
        reco[39]="No cuenta con usuarios potenciales que PRUEBEN LA PRODUCCIÓN A BAJA ESCALA de su producto, es necesario realizar más pláticas, reuniones y/o entrevistas con los usuarios potenciales, tampoco cuenta con actas de reunión y/o cartas de interés en las pruebas de su producto."
    ...
    if evaluacion.pregunta7_2==100:
        reco[40]="Cuenta con usuarios potenciales que PRUEBEN LA VERSIÓN FINAL de su producto, ha realizado más pláticas, reuniones y/o entrevistas con los usuarios potenciales, también cuenta con actas de reunión y/o cartas de interés en la versión final de su producto; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta7_2==0:
        reco[40]="No cuenta con usuarios potenciales que PRUEBEN LA VERSIÓN FINAL de su producto, es necesario realizar más pláticas, reuniones y/o entrevistas con los usuarios potenciales, tampoco cuenta con actas de reunión y/o cartas de interés en la versión final de su producto."
    ...
    if evaluacion.pregunta8_5==100:
        reco[41]="Elaboró el respectivo MANUAL DE USUARIO, SOPORTE TÉCNICO Y MANTENIMIENTO de la versión final de su producto, mediante la elaboración de un manual de instrucciones uso; dicho proceso e información se han completado y documentado satisfactoriamente."
    elif evaluacion.pregunta8_5==0:
        reco[41]="No elaboró el respectivo MANUAL DE USUARIO, SOPORTE TÉCNICO Y MANTENIMIENTO de la versión final de su producto, es necesario realizar un manual de instrucciones de uso."
    elif evaluacion.pregunta8_5<=13:
        reco[41]="No está seguro de contar con un MANUAL DE USUARIO, SOPORTE TÉCNICO Y MANTENIMIENTO de la versión final de su producto, sin embargo, es muy probable que no haya realizado un manual de instrucciones de uso. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta8_5<=25:
        reco[41]="Ya cuenta con un MANUAL DE USUARIO, SOPORTE TÉCNICO Y MANTENIMIENTO de la versión final de su producto, sin embargo, es necesario documentar el proceso realizado; debe contar un manual de instrucciones de uso. Asegúrese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta8_5<=50:
        reco[41]="Ya cuenta con un MANUAL DE USUARIO, SOPORTE TÉCNICO Y MANTENIMIENTO de la versión final de su producto, ha elaborado algún tipo de manual de instrucciones de uso, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."
    ...
    if evaluacion.pregunta4_6==100:
        reco[42]="La IDENTIFICACIÓN DE RIESGOS TECNOLÓGICOS de mercado y financieros de su invensión se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta4_6==0:
        reco[42]="No ha realizado la IDENTIFICACIÓN DE RIESGOS TECNOLÓGICOS de mercado y financieros de su invensión, es necesario realizar estudios básicos-preliminares de riesgos tecnológicos de mercado y financieros. Busque apoyo de un especialista"
    elif evaluacion.pregunta4_6<=13:
        reco[42]="No está seguro de haber realizado la IDENTIFICACIÓN DE RIESGOS TECNOLÓGICOS de mercado y financieros de su invensión, sin embargo, es muy probable que no haya realizado estudios básicos-preliminares de riesgos. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta4_6<=25:
        reco[42]="Ya ha iniciado con la IDENTIFICACIÓN DE RIESGOS TECNOLÓGICOS de mercado y financieros de su invensión, sin embargo, es necesario documentar el proceso realizado; deben ser estudios básicos-preliminares. Busque apoyo de un especialista. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta4_6<=50:
        reco[42]="Ya ha iniciado con la IDENTIFICACIÓN DE RIESGOS TECNOLÓGICOS de mercado y financieros de su invensión, ha realizado estudios básicos-preliminares de riesgos, sin embargo, es necesario revisar cuidadosamente la información disponible  y la documentación realizada durante el proceso."



    if evaluacion.pregunta6_4==100:
        reco[43]="Cuenta con una ORGANIZACIÓN OPERATIVA acorde a las necesidades de operación de la producción; considerando aspectos como mercadotecnia, logística, producción y otros, documentado en un brochure y/o perfil de la organización, todo este proceso e información se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta6_4==0:
        reco[43]="No cuenta con una ORGANIZACIÓN OPERATIVA acorde a las necesidades de operación de la producción; considerando aspectos como mercadotecnia, logística, producción y otros; no cuenta con un brochure y/o perfil de la organización."
    ...
    if evaluacion.pregunta7_3==100:
        reco[44]="Cuenta con una ESTRUCTURA ORGANIZACIONAL adecuada para la implementación; considerando organigrama, acta constitutiva, plan de negocios, cédula fiscal y otros similares; todo este proceso e información se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta7_3==0:
        reco[44]="No cuenta con una ESTRUCTURA ORGANIZACIONAL adecuada para la implementación; no ha considerado aspectos como organigrama, acta constitutiva, plan de negocios, cédula fiscal y otros similares."
    ...
    if evaluacion.pregunta8_3==100:
        reco[45]="Cuenta con una organización OPERATIVA AL 100%, realiza declaraciones fiscales, contratos, pago de nómina, pago de impuestos y otros similares; todo este proceso e información se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta8_3==0:
        reco[45]="No cuenta con una organización OPERATIVA AL 100%, no realiza declaraciones fiscales, contratos, pago de nómina, pago de impuestos y otros similares."
    elif evaluacion.pregunta8_3<=13:
        reco[45]="No está seguro de contar con una organización OPERATIVA AL 100%, sin embargo, es muy probable que no realice declaraciones fiscales, contratos, pago de nómina, pago de impuestos y otros similares. Revise cuidadosamente la información disponible y documentación realizada."
    elif evaluacion.pregunta8_3<=25:
        reco[45]="Ya cuenta con una organización OPERATIVA AL 100%, sin embargo, es necesario documentar el proceso realizado; debe realizar declaraciones fiscales, contratos, pago de nómina, pago de impuestos y otros similares. Asegurese de realizar correctamente la documentación respectiva."
    elif evaluacion.pegunta8_3<=50:
        reco[45]="Ya cuenta con una organización OPERATIVA AL 100%, es muy probable que realice declaraciones fiscales, contratos, pago de nómina, pago de impuestos u otros similares, sin embargo, es necesario revisar cuidadosamente la información disponible y la documentación realizada durante el proceso."



    if evaluacion.pregunta9_2==100:
        reco[46]="Cuenta con un producto con CRECIMIENTO DE MERCADO, realiza ventas sostenidas y producción a gran volumen, cuenta con reportes de venta y proyecciones de mercado; todo este proceso e información se ha completado y documentado satisfactoriamente."
    elif evaluacion.pregunta9_2==0:
        reco[46]="No cuenta con un producto con CRECIMIENTO DE MERCADO, no realiza ventas sostenidas y tampoco producción a gran volumen, no cuenta con reportes de venta ni proyecciones de mercado."
    ...
    icons[26]=evaluacion.pregunta6_1 
    icons[27]=evaluacion.pregunta6_2
    icons[28]=evaluacion.pregunta6_3 
    icons[29]=evaluacion.pregunta6_4 
    icons[30]=evaluacion.pregunta6_5
    icons[31]=evaluacion.pregunta7_1 
    icons[32]=evaluacion.pregunta7_2
    icons[33]=evaluacion.pregunta7_3
    icons[34]=evaluacion.pregunta7_4
    icons[35]=evaluacion.pregunta8_1
    icons[36]=evaluacion.pregunta8_2
    icons[37]=evaluacion.pregunta8_3
    icons[38]=evaluacion.pregunta8_4
    icons[39]=evaluacion.pregunta8_5
    icons[40]=evaluacion.pregunta9_1
    icons[41]=evaluacion.pregunta9_2
    icons[42]=evaluacion.pregunta9_3  
    icons[43]=evaluacion.pregunta9_4
