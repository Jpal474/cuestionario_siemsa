...
def exportar_pdf(request,id):
    ...
    html = render_to_string("resultados_pdf.html", {'evaluacion':evaluacion, 'estatus':estatus, 'iconos':iconos, 'colores':colores, 'conclusiones': conclusiones, 'recomendaciones':recomendaciones})
